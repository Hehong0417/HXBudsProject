...
//    
//    if (!_cancelButton) {
//        _cancelButton = [[UIButton alloc]initWithFrame:CGRectMake(0, 23, 65, 38)];
//        [_cancelButton addTarget:self action:@selector(cancelAction:) forControlEvents:UIControlEventTouchUpInside];
//        [_cancelButton setTitle:@"取消" forState:UIControlStateNormal];
//        [_cancelButton setTitleColor:[UIColor colorWithRed:175/255.0 green: 175/255.0 blue:175/255.0 alpha:1] forState:UIControlStateNormal];
...
//    if (!_pulishButton) {
//        
//        _pulishButton = [[UIButton alloc]initWithFrame:CGRectMake(SCREEN_WIDTH - 80, 23,60, 30) ];
//        UIColor *color = [UIColor colorWithRed:175/255.0 green: 175/255.0 blue:175/255.0 alpha:1] ;
//        [_pulishButton addTarget:self action:@selector(pulishAction:) forControlEvents:UIControlEventTouchUpInside];
//        [_pulishButton setTitle:@"发布" forState:UIControlStateNormal];
//        [_pulishButton setTitleColor:color forState:UIControlStateNormal];
//        _pulishButton.layer.cornerRadius = 3;
//        _pulishButton.layer.borderWidth = 1;
//        _pulishButton.layer.borderColor = color.CGColor;
//        _pulishButton.layer.masksToBounds = YES;
//        _pulishButton.titleLabel.font = [UIFont systemFontOfSize:14];
//    }
//    
//    return _pulishButton;
//}
//
...
//       [self.view addSubview:self.pulishButton];
//    
//}
